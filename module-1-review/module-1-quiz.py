...
print("   Answer: The = operator is used for assignment, meaning it assigns a value to a variable.")
print("   The == operator is used for comparison, checking if two values are equal.")

print("\n7. What is the modulus operator (%) used for? Give an example.")
print("   Answer: The modulus operator (%) is used to find the remainder of a division.")
print("   For example: 10 % 4 returns 2, because 10 divided by 4 is 2 with a remainder of 2.")

print("\n8. Why do we need to use str() when concatenating numbers with strings?")
print("   Answer: We need to use str() to convert numbers to strings before concatenation.")
print("   This is because Python does not allow concatenation of strings and non-strings.")
...
print("    title = 'Scandal'")
print("    year = 2000")
print("    message = f'My favorite movie is {title} from {year}.'")
print("    print(message)")
...
print("    days = 100")
print("    weeks = days // 7")
print("    remaining_days = days % 7")
print("    print(f'{days} days = {weeks} weeks and {remaining_days} days')")
...
print()
print("    Code:")
print("    Math_book = 89.99")
print("    Science_book = 76.50")
print("    History_book = 65.25")
print("    Student_discount = 0.15")
print("    Original_total = Math_book + Science_book + History_book")
print("    Discount_amount = Original_total * Student_discount")
print("    Final_total = Original_total - Discount_amount")
print("    print(f'Original total: ${Original_total:.2f}')")
print("    print(f'Discount amount: ${Discount_amount:.2f}')")
print("    print(f'Final total: ${Final_total:.2f}')")
